...
Il glossario non prevede la sezione di introduzione e non necessita di altri file aggiuntivi, si 
è deciso che si userà l'ordine alfabetico così da facilitarne la ricerca, nell'indice compariranno 
tutte le parole presenti nel documento. Ogni lettera dell'alfabeto costituirà una nuova 
sezione e ogni parola avrà la sua sottosezione con scritto il significato. \newline
...
configuration la scrittura in corsivo del termine e l'aggiunta del pedice.
...
\begin{itemize}
        ...
        \item \textbf{Elenchi} gli elementi dell'elenco vanno in grassetto solo se è prevista una descrizione. \\
                                Nel caso di elenchi annidati, non si usa più il grassetto.
\end{itemize}
